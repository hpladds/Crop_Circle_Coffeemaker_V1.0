...
module channel1(){
    rotate ([0,0,270])
        rotate_extrude(angle=90, $fn = 300)
            translate([.5, 0]) square([.6,.325],true);
    ...
    translate([0,1.11,-.001])
      ...
      translate([.14, 1.25,-.064])
      rotate ([0,0,45])
        cube([.6, 1.4,.225],false); 
}

module channel2(){  
    translate([-1.864, -8.75,-.064])
        cube([.6, 1.25,.225],false);
...
module channel3(){
    ...
    rotate([0,0,90])
        rotate_extrude(angle=90, $fn = 300)
            translate([.5, 0]) square([.6,.525],true);
